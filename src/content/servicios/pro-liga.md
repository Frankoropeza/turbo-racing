---
title: Pro Liga México — Competencia de RC y FPV
...
hero:
  ...
  botones:
    - { label: Inscribirse a la liga, href: '/contacto/?servicio=pro-liga', estilo: solido }
    - { label: Ver equipos de competencia, href: /catalogo/carros-rc/, estilo: contorno }
resumen:
  nombre: Pro Liga México
  texto: La arena para los expertos. Competencias de FPV Racing y drift RC con ranking de pilotos y premios.
  puntos: ['Cronometraje por vuelta', 'Pistas técnicas', 'Categorías FPV y drift']
...
---
La Pro Liga México de Turbo Racing es un espacio de alta competencia diseñado para elevar el nivel técnico de los pilotos, con reglamento por categoría para competir en igualdad de condiciones.

No solo competimos por trofeos: competimos por la perfección técnica en cada curva y cada despegue.
